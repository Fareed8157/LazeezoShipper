package com.example.fareed.lazeezoshipper.Common;
...
import com.example.fareed.lazeezoshipper.Model.ShippingInformation;
import com.example.fareed.lazeezoshipper.Remote.IGeoCoordinates;
import com.example.fareed.lazeezoshipper.Remote.RetrofitClient;
...
/**
 * Created by fareed on 16/04/2018.
 */
...
public class Common {
    ...
    public static String ORDER_NEED_SHIP_TABLE="OrdersNeedShip";
    public static String SHIPPER_INFO_TABLE="ShippinOrders";
